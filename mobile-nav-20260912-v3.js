  ...
  function injectStyles() {
    ...
    style.textContent = `
      @media(max-width:${BREAKPOINT}px){
        ...
        .smn-head{display:flex;align-items:center;justify-content:space-between;gap:14px;padding:16px 16px 14px;border-bottom:1px solid rgba(23,35,66,.09);background:#fff;flex:0 0 auto}
        .smn-brand{display:flex;align-items:center;gap:10px;min-width:0;text-decoration:none!important}
        .smn-brand img{width:54px;height:40px;object-fit:contain;flex:0 0 auto}
        .smn-brand-text{display:flex;flex-direction:column;min-width:0}
        .smn-brand-text b{font:800 14px/1.2 Manrope,"DM Sans",sans-serif;color:#132443}
        .smn-brand-text small{margin-top:3px;font:700 9px/1.2 "DM Sans",sans-serif;letter-spacing:.1em;text-transform:uppercase;color:#7b86a0}
        ...
        .smn-scroll{flex:1;min-height:0;overflow-y:auto;-webkit-overflow-scrolling:touch;padding:14px 14px 28px;background:#fbfcff}
        .smn-main{display:grid;gap:8px}
        .smn-link,.smn-products-toggle{width:100%;min-height:50px;border:0;border-radius:14px;background:#fff;color:#172342;display:flex;align-items:center;justify-content:space-between;gap:12px;padding:13px 15px;text-decoration:none!important;font:800 14px/1.2 Manrope,"DM Sans",sans-serif;box-shadow:0 1px 0 rgba(23,35,66,.07);cursor:pointer;text-align:left}
